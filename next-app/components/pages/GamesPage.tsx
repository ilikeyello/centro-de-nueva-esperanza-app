...
import { Sparkles, Brain, Grid3X3, Gamepad2 } from "lucide-react";
  ...
  return (
    ...
    >
      <section className="flex-shrink-0 px-4 pt-4 pb-2 text-center md:text-left">
        ...
        <h1 className="text-2xl font-bold text-white mb-1">{language === "es" ? "Juegos" : "Games"}</h1>
        ...
        >
          <CardContent className="p-3 h-full flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-lg font-bold text-white">{language === "es" ? "Trivia Bíblica" : "Bible Trivia"}</h3>
            </div>
        ...
        >
          <CardContent className="p-3 h-full flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-lg font-bold text-white">{language === "es" ? "Sopa de Letras" : "Word Search"}</h3>
            </div>
            <p className="text-neutral-400 text-xs line-clamp-2">
              {language === "es"
        ...
        >
          <CardContent className="p-3 h-full flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-lg font-bold text-white">Graveyard Shift</h3>
            </div>
            <p className="text-neutral-400 text-xs line-clamp-2">
              {language === "es" ? "Un juego de aventuras y misterio emocionante." : "An exciting adventure and mystery game."}
            </p>
          </CardContent>
        </Card>
      </section>
