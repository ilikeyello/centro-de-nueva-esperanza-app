    ...
    <div className="pb-10">
      <section className="relative -mt-20 md:-mt-16">
        ...
        <div className="absolute top-20 right-4 md:top-24 z-20">
          ...
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-6 text-center sm:px-10 safe-area-padding translate-y-8 md:-translate-y-24">
