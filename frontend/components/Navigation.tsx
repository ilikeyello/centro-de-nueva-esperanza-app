    ...
    >
      <div className={cn("container mx-auto py-0")}>
        <div className="flex w-full flex-col gap-1 md:flex-col-reverse">
          ...
          {livestreamIsLive && currentPage !== "media" && !isDesktop && !isLivestreamPipDismissed && hasInteractedWithLivestream && (isLivestreamPlaying || isLivestreamTransitioning) && (
          ...
          {livestreamIsLive && currentPage !== "media" && isDesktop && isLivestreamPipMinimized && !isLivestreamPipDismissed && hasInteractedWithLivestream && (isLivestreamPlaying || isLivestreamTransitioning) && (
