...
```bash
git remote add encore encore://bilingual-church-community-app-8dn2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/bilingual-church-community-app-8dn2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/bilingual-church-community-app-8dn2/settings/integrations/github)
