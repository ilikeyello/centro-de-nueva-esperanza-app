...
// Simple language context for standalone trivia game
const useLanguage = () => {
        ...
        <Card className={`bg-neutral-900 border-2 ${passed ? 'border-green-600' : 'border-red-600'}`}>
          <CardContent className="p-8 text-center space-y-6">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Button onClick={() => window.location.href = '/cne-app/#games'} variant="outline" className="border-neutral-700 hover:bg-neutral-800">
                <ArrowLeft className="h-4 w-4 mr-2" />
                {t("Back to Games", "Volver a Juegos")}
              </Button>
            </div>
